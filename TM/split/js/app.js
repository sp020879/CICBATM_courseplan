    ...
    <div class="sc-body">
      ...
      <div class="gpa-row">
        ...
        <div class="gpa-item"><div class="gpa-label">GPA 历史</div>
          ${hist.length?`<div style="font-family:var(--mono);font-size:10px;color:var(--ink2);margin-top:3px;line-height:1.7">${hist.map(g=>`<span style="color:${g>=2?'var(--g7)':g>=1.5?'var(--amber)':'var(--red)'}">${g}</span>`).join('<br>')}</div>`:`<div style="font-size:10px;color:var(--ink3);margin-top:3px">—</div>`}
        </div>
      </div>
